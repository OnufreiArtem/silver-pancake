...
const MainContent = ({ onSearchBarChanged, onSearch, searchResult, searchBarText, colorScheme }) => {
        ...
        <ContentLayout>
            <SearchLayout>
                ...
                <SearchBar>
                    ...
                    <SearchButton colorScheme={colorScheme} onClick={_ => onSearch(searchBarText)}>
